...
class AboutScreen extends StatelessWidget {
  ...
  final List<Widget> people = ["Lilian Danciger,Presidente", "Gioele Pannetto,Vice Presidente & App Developer,https://instagram.com/giopan.sh", "Daniele,Caporedattore", "Tommaso Piccardi,Caposervizi,https://www.instagram.com/tommys_poetry"].map((f) {
